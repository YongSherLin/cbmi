...
let expName = 'intervention';  // from the Builder filename that created this script
let expInfo = {
    'participant': '',
};
...
async function experimentInit() {
  ...
  text = new visual.TextStim({
    win: psychoJS.window,
    name: 'text',
    text: "Welcome to the study!\nYou will see different social situations.\nPlease choose the best interpretation.\nPress 'z' for the LEFT option, 'm' for the RIGHT option.\nPress SPACE to begin.\n",
    font: 'Arial',
    units: undefined, 
...
var frameN;
var continueRoutine;
var Instructions_ScreenMaxDurationReached;
var _key_resp_allKeys;
var Instructions_ScreenMaxDuration;
...
function Instructions_ScreenRoutineBegin(snapshot) {
  return async function () {
    ...
    Instructions_ScreenMaxDurationReached = false;
    // update component parameters for each repeat
    key_resp.keys = undefined;
    key_resp.rt = undefined;
    _key_resp_allKeys = [];
    psychoJS.experiment.addData('Instructions_Screen.started', globalClock.getTime());
    Instructions_ScreenMaxDuration = null
    // keep track of which components have finished
    Instructions_ScreenComponents = [];
    Instructions_ScreenComponents.push(text);
    Instructions_ScreenComponents.push(key_resp);
